...
// ================================================================
//  ВИБІР ПЛАТИ — розкоментуй ОДНУ з двох:
// ================================================================
...
// ========== Платозалежні налаштування ==========
  ...
  const int LED_RED_PIN = 2;    // Змінити при потребі
  const int LED_BLUE_PIN = 4;   // Змінити при потребі
...
//
// DevKit V1 (окремі червоний + синій):
